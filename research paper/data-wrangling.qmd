...
```{r}
# bt_speeches <- read.csv("data/Bundestag.csv")
# bt_speeches_from2020 <- bt_speeches[bt_speeches$Date >= 2020,]
# write.csv(bt_speeches_from2020, "bundestag_seit2020.csv")
...
bt_speeches_nointerjections[1:2,]
```
...
arrange(X, .bygroup=TRUE) |>
summarise(Speech = paste(Speech, collapse=" "))

bt_speeches_combined |> nrow()
bt_speeches_combined$Date |> max()
```
The dataset contains 22137 speeches from 2020 to 2023
