...
# write.csv(bt_speeches_combined, "bundestag_seit2020.csv")
...
```{r}
bt_speeches <- merge(bt_speeches, bt_meta, by="MPID")
...
bt_speeches_combined$Date |> min()


```
The dataset contains 22137 speeches from 2020-01-15 to 2023-04-26
